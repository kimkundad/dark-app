...
class CustomerEmController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.employee.customer_manager.index');
    }
    ...
    public function create()
    {
        ...
        $data['cat'] = $cat;
        $data['method'] = "post";
        $data['url'] = url('admin/customer_manager_em');
        return view('admin.employee.customer_manager.create', $data);
    }
              ...
              //  dd($data);
                return Datatables::of($data)
                        ...
                        ->addColumn('action', function($row){
                                ...
                                $btn = '<a href="'.url('admin/customer_manager_em/'.$row->id_q.'/edit').'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
    ...
    public function store(Request $request)
    {
        ...
        return redirect(url('admin/customer_manager_em'))->with('add_success','เพิ่ม เสร็จเรียบร้อยแล้ว');
    ...
    public function customer_manager_his($id)
    {
        ...
        return view('admin.employee.customer_manager.customer_manager_his', compact('objs'));
    }
    ...
    public function get_customer_manager_his(Request $request, $id){
        ...
        return view('admin.employee.customer_manager.customer_manager_his');
    ...
    public function edit($id)
    {
        ...
        $data['cat'] = $cat;
        $objs = customer_manager::find($id);
        $data['url'] = url('admin/customer_manager_em/'.$id);
        $data['method'] = "put";
        $data['objs'] = $objs;
        $data['c_id'] = $id;
        return view('admin.employee.customer_manager.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $status = 0;
           ...
           $objs->save();
            ...
            return redirect(url('admin/customer_manager_em/'.$id.'/edit'))->with('edit_success','คุณทำการเพิ่มอสังหา สำเร็จ');
