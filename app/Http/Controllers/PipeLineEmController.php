...
class PipeLineEmController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $objs->setPath('');
        $data['objs'] = $objs;
        return view('admin.employee.pipeline.index', compact('objs'));
    }
    ...
    public function create()
    {
        //
        $data['method'] = "post";
        $data['url'] = url('admin/pipeline_em');
        return view('admin.employee.pipeline.create', $data);
    }
    ...
    public function store(Request $request)
    {
      //  dd($request->all());
        ...
        sup_pipeline::insert($pipeline);
           ...
           return redirect(url('admin/pipeline_em'))->with('add_success','เพิ่ม เสร็จเรียบร้อยแล้ว');
    }
    ...
    public function edit($id)
    {
        ...
        $data['url'] = url('admin/pipeline_em/'.$id);
        $data['method'] = "put";
        $data['objs'] = $objs;
        $data['sub'] = $sub;
        return view('admin.employee.pipeline.edit', $data);
    }
    ...
    public function update(Request $request, $id)
    {
       ...
       // dd($request->kt_docs_repeater_basic);
        ...
        // sup_pipeline::insert($pipeline);
           ...
           return redirect(url('admin/pipeline_em/'.$id.'/edit'))->with('add_success','เพิ่ม เสร็จเรียบร้อยแล้ว');
    }
    ...
    public function del_pipeline($id)
    {
        //
            ...
            return redirect(url('admin/pipeline_em/'))->with('del_success','คุณทำการลบอสังหา สำเร็จ');
    }
}
