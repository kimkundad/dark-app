...
class crmLeadFollowEmController extends Controller
{
    /**
    ...
    public function get_crm_lead_follow(Request $request){
        ...
        if ($request->ajax()) {
            ...
            $data = DB::table('follow_pipes')->select(
                ...
                ->where('follow_pipes.upsale_idx', Auth::user()->id)
            ...
            return Datatables::of($data)
                        ...
                        ->addColumn('action', function($row){
                                ...
                                $btn = '<a href="'.url('admin/crm_lead_list_view_em/'.$row->id_q).'" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
        ...
        return view('admin.employee.crm_lead_follow.index');
    ...
    public function crm_lead_follow()
    {
        ...
        return view('admin.employee.crm_lead_follow.index', compact('objs', 'count', 'count2', 'user'));
    }
