    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/create_lead')) ? 'active' : '' }}" href="{{ url('/admin/create_lead')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/lead_import')) ? 'active' : '' }}" href="{{ url('/admin/lead_import')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <span class="menu-title">นำเข้า Lead จากคำสั่งซื้อ</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/waiting_distribute_crm*')) ? 'active' : '' }}" href="{{ url('/admin/waiting_distribute_crm')}}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/all_orders*')) ? 'active' : '' }}" href="{{ url('/admin/all_orders')}}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/crm_lead_follow')) ? 'active' : '' }}" href="{{ url('/admin/crm_lead_follow')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/crm_lead_status')) ? 'active' : '' }}" href="{{ url('/admin/crm_lead_status')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="14" height="21"
                                    viewBox="0 0 14 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path opacity="0.3"
                        ...
                        <span class="menu-title">รายการสถานะติดตาม Lead</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">ผู้ใช้งาน</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/user_manager*')) ? 'active' : '' }}" href="{{ url('/admin/user_manager')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/customer_manager*')) ? 'active' : '' }}" href="{{ url('/admin/customer_manager')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">รายการสินค้า</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ (request()->is('admin/product_manager*')) ? 'active' : '' }}" href="{{ url('/admin/product_manager')}}">
                        ...
                        <span class="menu-title">รายการสินค้า</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/sale_contact*')) ? 'active' : '' }}" href="{{ url('/admin/sale_contact')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">ช่องทางการขาย</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <div class="menu-item">
                    ...
                    <a class="menu-link {{ (request()->is('admin/transport*')) ? 'active' : '' }}" href="{{ url('/admin/transport')}}">
                        ...
                        <span class="menu-title">ขนส่ง</span>
                    </a>
                    <!--end:Menu link-->
                </div>
