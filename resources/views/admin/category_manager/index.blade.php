        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">หมวดหมู่สินค้า</h1>
                    <!--end::Title-->
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div class="m-0">
                        <!--begin::Menu toggle-->
                        <a href="{{ url('admin/category/create') }}" class="btn btn-sm btn-success btn-flex" >
                                ...
                                <tbody >
                                    ...
                                    <tr id="{{$item->id}}">
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ $item->catname }}</a>
                                                </div>
                                                <!--end::Name-->
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a href="{{ url('api/del_cat/'.$item->id) }}" onclick="return confirm('คุณต้องการลบข้อมูลนี้ใช่ไหม?')" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
