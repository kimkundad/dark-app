...
@section('title')
<title>แก้ไข หมวดหมู่สินค้า</title>
@stop
@section('stylesheet')
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="catname" class="form-control form-control-lg form-control-solid" placeholder="เศษเหล็ก อลูมิเนียม" value="{{ $objs->catname }}">
