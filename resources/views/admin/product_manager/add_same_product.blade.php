        ...
        <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">สร้างรายการสินค้า</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form id="kt_account_profile_details_form" class="form" method="POST" action="{{ url('admin/post_same_product') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="pro_name" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกชื่อสินค้า..." value="{{ $name }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="pro_code" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกรหัสสินค้า..." value="{{old('pro_code') ? old('pro_code') : ''}}">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="bar_code" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกรหัสบาร์โค้ด..." value="{{ $rand }}">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <textarea class="form-control form-control-lg form-control-solid" id="textareaAutosize" placeholder="รายละเอียดสินค้า..." rows="4" name="detail" >{{old('detail') ? old('detail') : ''}} </textarea>
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="number" name="price" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกราคา..." value="{{ $price }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="number" name="cost" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกต้นทุน..." value="{{old('cost') ? old('cost') : ''}}">
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" name="tax">
                                            <option value="1">คำนวนภาษี</option>
                                            <option value="0">ไม่คำนวนภาษี</option>
                                        </select>
                                    </div>
                                    <!--begin::Label-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="number" name="total" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกจำนวนสินค้า..." value="{{old('total') ? old('total') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="number" name="weight" class="form-control form-control-lg form-control-solid" placeholder="กรอกน้ำหนัก (กรัม)..." value="{{old('weight') ? old('weight') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <input type="number" name="width" class="form-control form-control-lg form-control-solid" placeholder="กรอกกว้าง..." value="{{old('width') ? old('width') : ''}}">
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="number" name="height" class="form-control form-control-lg form-control-solid" placeholder="กรอกสูง..." value="{{old('height') ? old('height') : ''}}">
                                            </div>
                                            <div class="col-lg-4">
                                                <input type="number" name="pro_length" class="form-control form-control-lg form-control-solid" placeholder="กรอกยาว..." value="{{old('pro_length') ? old('pro_length') : ''}}">
                                            </div>
                                        </div>
                                    </div>
                                    <!--end::Col-->
