                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <span class="symbol-label bg-light-success">
                                                <img src="{{ url('admin/assets/media/img/currency_exchange.svg.png') }}" class="w-50px" alt="">
                                            </span>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">ยอดขายรวม</span>
                                                <span class="card-label fw-bold text-gray-800">{{ number_format($sum_price_final2,2) }} บาท</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <span class="symbol-label bg-light-success">
                                                <img src="{{ url('admin/assets/media/img/crm.png') }}" class="w-50px" alt="">
                                            </span>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">ยอดขายCRM รวม </span>
                                                <span class="card-label fw-bold text-gray-800">{{ number_format($crm,2) }} บาท</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <div class="symbol symbol-40px symbol-circle me-5">
                                                <span class="symbol-label bg-light-success">
                                                    <img src="{{ url('admin/assets/media/img/left-arrow_5111833.png') }}" class="w-50px" alt="">
                                                </span>
                                            </div>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">ยอดตีกลับรวม</span>
                                                <span class="card-label fw-bold text-gray-800">0 บาท</span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <span class="symbol-label bg-light-success">
                                                <img src="{{ url('admin/assets/media/img/gui_paid.png') }}" class="w-50px" alt="">
                                            </span>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">จำนวนคำสั่งซื้อรวม</span>
                                                <span class="card-label fw-bold text-gray-800">{{ number_format($sum, 0) }} </span>
                                            </h4>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">จำนวนคำสั่งซ์้อ CRMรวม</span>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <span class="symbol-label bg-light-success">
                                                <img src="{{ url('admin/assets/media/svg/avatars/001-boy.svg') }}" class="h-75 align-self-end" alt="">
                                            </span>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">ค่าคอมมิ่ชชั่นรวม</span>
                                                <span class="card-label fw-bold text-gray-800">2,037 บาท</span>
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-40px symbol-circle me-5">
                                            <span class="symbol-label bg-light-success">
                                                <img src="{{ url('admin/assets/media/img/gui_donate_icon_157168.png') }}" class="w-50px" alt="">
                                                
                                            </span>
                                        </div>
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">รายจ่ายรวม</span>
                                                <span class="card-label fw-bold text-gray-800">2,037 บาท</span>
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <div class="card h-lg-100">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="m-0">
                                            <h4 class="card-title d-flex align-items-start flex-column">
                                                <span class="text-gray-400 mt-1 fw-bold fs-7">กำไรรวม</span>
                                                <span class="card-label fw-bold text-gray-800">2,037 บาท</span>
                                            </h4>
                                        </div>
                                    </div>
