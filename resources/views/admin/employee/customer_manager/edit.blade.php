                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">แก้ไข ข้อมูลพนักงาน ใหม่</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('{{ url('admin/assets/media/svg/avatars/blank.svg') }}')">
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ url('images/dark-app/avatar/'.$objs->avatar) }})"></div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="fullname" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกชื่อ - นามสกุล..." value="{{ $objs->fullname }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="phone" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกเบอร์ติดต่อ..." value="{{ $objs->phone }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="input-group ">
                                            <input class="form-control form-control-solid rounded rounded-end-0" name="hbd" placeholder="กรุณากรอกวันเกิด..." value="{{ $objs->hbd }}" id="kt_datepicker_2" />
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="line" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกข้อมูลไลน์ไอดี..." value="{{ $objs->line }}">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mr-15">
                                                <input class="form-check-input" type="radio" name="sex" @if($objs->sex == 'ไม่ระบุ') checked @endif  value="ไม่ระบุ" id="flexRadioLg"/>
                                                <label class="form-check-label" for="flexRadioLg">
                                                    ไม่ระบุ
                                                </label>
                                            </div>
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mr-15">
                                                <input class="form-check-input" type="radio" name="sex" @if($objs->sex == 'ชาย') checked @endif value="ชาย" id="flexRadioLg"/>
                                                <label class="form-check-label" for="flexRadioLg">
                                                    ชาย
                                                </label>
                                            </div>
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mr-15">
                                                <input class="form-check-input" type="radio" name="sex" @if($objs->sex == 'หญิง') checked @endif value="หญิง" id="flexRadioLg"/>
                                                <label class="form-check-label" for="flexRadioLg">
                                                    หญิง
                                                </label>
                                            </div>
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mr-15">
                                                <input class="form-check-input" type="radio" name="sex" @if($objs->sex == 'อื่นๆ') checked @endif value="อื่นๆ" id="flexRadioLg"/>
                                                <label class="form-check-label" for="flexRadioLg">
                                                    อื่นๆ
                                                </label>
                                            </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <select class="form-select" name="type_address" aria-label="Select example">
                                            ...
                                            <option value="บ้านเดี่ยว" @if( $objs->typtype_addressePrice == 'บ้านเดี่ยว')
                                                selected='selected'
                                                @endif>บ้านเดี่ยว</option>
                                            <option value="อาคารพาณิชย์" @if( $objs->typtype_addressePrice == 'อาคารพาณิชย์')
                                                selected='selected'
                                                @endif>อาคารพาณิชย์ </option>
                                            <option value="ทาวน์เฮาส์" @if( $objs->typtype_addressePrice == 'ทาวน์เฮาส์')
                                                selected='selected'
                                                @endif>ทาวน์เฮาส์ </option>

                                            <option value="อพาร์ตเม้นต์" @if( $objs->typtype_addressePrice == 'อพาร์ตเม้นต์')
                                                selected='selected'
                                                @endif>อพาร์ตเม้นต์  </option>
                                            <option value="คอนโดมิเนียม" @if( $objs->typtype_addressePrice == 'คอนโดมิเนียม')
                                                selected='selected'
                                                @endif>คอนโดมิเนียม </option>
                                            <option value="ออฟฟิศ">ออฟฟิศ </option>
                                            <option value="สถานที่ราชการ" @if( $objs->typtype_addressePrice == 'สถานที่ราชการ')
                                                selected='selected'
                                                @endif>สถานที่ราชการ </option>
                                            <option value="Single-Family Homes" @if( $objs->typtype_addressePrice == 'Single-Family Homes')
                                                selected='selected'
                                                @endif>Single-Family Homes </option>
                                            <option value="Mobile House" @if( $objs->typtype_addressePrice == 'Mobile House')
                                                selected='selected'
                                                @endif>Mobile House </option>
                                        </select>
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="address" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกที่อยู่..." value="{{ $objs->address }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="Subdistrict" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกแขวง/ ตำบล..." value="{{ $objs->Subdistrict }}">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="district" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกเขต/ อำเภอ..." value="{{ $objs->district }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="province" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกจังหวัด..." value="{{ $objs->province }}">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="zip_code" class="form-control form-control-lg form-control-solid" placeholder="กรุณากรอกรหัสไปรษณีย์..." value="{{ $objs->zip_code }}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-6 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="county" class="form-control form-control-lg form-control-solid"  value="{{ $objs->county }}">
