                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr id="{{ $u->id_f }}">
                                    ...
                                    <td class="text-end pe-0">
                                        ...
                                        <a class="clickme" id="clickme{{ $u->id_f }}" href="#">
                                    ...
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                                    <a href="{{ url('admin/crm_lead_list_view/'.$u->id_q) }}" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
...
<script type="text/javascript">
        ...
        $.ajax({
                type:'POST',
                url:'{{url('api/api_post_status_follow_em')}}',
    ...
    $(function () {
      ...
      var table = $('.data-table').DataTable({
          ...
          serverSide: true,
          ajax: {
              url: "{{ url('api/get_crm_lead_follow_em') }}",
              data:function (d) {
