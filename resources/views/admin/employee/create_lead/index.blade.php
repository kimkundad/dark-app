...
<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper" data-kt-stepper="true">
        ...
        <div class="flex-row-fluid py-lg-5 px-lg-15">
            <!--begin::Form-->
            <form class="form"  method="POST" action="{{ url('admin/post_new_lead_em') }}" id="kt_modal_create_app_form">
                ...
                <div data-kt-stepper-element="content">
                    <div class="w-100">
                        ...
                        <div class="row mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" value="{{ Auth::user()->name }}" />
                            <input type="hidden" name="upsale_id" value="{{ Auth::user()->id }}" />
                            <!--end::Input-->
                            </div>
                            <div class="col-6 mb-10">
                                <!--begin::Label-->
