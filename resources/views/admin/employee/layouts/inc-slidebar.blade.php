    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/employee_dashboard')) ? 'active' : '' }}" href="{{ url('/admin/employee_dashboard')}}">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/pipeline_em*')) ? 'active' : '' }}" href="{{ url('/admin/pipeline_em')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/create_lead_em')) ? 'active' : '' }}" href="{{ url('/admin/create_lead_em')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/crm_lead_list_em*')) ? 'active' : '' }}" href="{{ url('/admin/crm_lead_list_em')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/all_orders_em*')) ? 'active' : '' }}" href="{{ url('/admin/all_orders_em')}}">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/crm_lead_follow_em')) ? 'active' : '' }}" href="{{ url('/admin/crm_lead_follow_em')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ (request()->is('admin/customer_manager_em*')) ? 'active' : '' }}" href="{{ url('/admin/customer_manager_em')}}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
