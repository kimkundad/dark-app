                            ...
                            <div class="card-body py-3">
                                        ...
                                        <div class="modal fade" tabindex="-1" id="kt_modal_change_upsale">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="form" method="POST" action="{{ url('admin/add_change_upsale_he/'.$objs->id_q) }}" enctype="multipart/form-data">
                                                        {{ csrf_field() }}
                                ...
                                @else
                                    ...
                                    <div class="mt-10">
                                        ...
                                        <form class="form" method="POST" action="{{ url('admin/add_timeline_pipeline_he/'.$objs->id_q) }}" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-4 col-xxl-4 mb-md-5 mb-xl-10">
                        ...
                        <div class="card mb-5 mb-xl-8 ">
                            <div class="card-header pt-5">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="{{ url('admin/add_order_list_he/'.$objs->id_q) }}" class="btn btn-sm btn-light">สร้างคำสั่งซื้อใหม่</a>
                                </div>
                                <!--end::Toolbar-->
                            </div>
                            <div class="card-body py-3">
                                ...
                                <div class="modal fade" tabindex="-1" id="kt_modal_add_follow">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form class="form" method="POST" action="{{ url('admin/add_following_pipe_he/'.$objs->id_q) }}" enctype="multipart/form-data">
                                                {{ csrf_field() }}
                                            <div class="modal-body">
