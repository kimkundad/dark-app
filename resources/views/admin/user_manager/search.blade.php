        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">ข้อมูลพนักงาน</h1>
                    <!--end::Title-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">ข้อมูลพนักงาน</li>
                        <!--end::Item-->
                    </ul>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <div class="m-0">
                        <!--begin::Menu toggle-->
                        <a href="{{ url('admin/user_manager/create') }}" class="btn btn-sm btn-success btn-flex" >
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar gap-5">
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <!--end::Svg Icon-->
                                <input type="text" name="search" class="form-control form-control-solid w-250px ps-14" placeholder="ค้นหาจาก ชื่อ-นามสกุล" value="{{$search}}" />
                            </div>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                    <div class="symbol-label">
                                                        <img src="{{ url('admin/assets/media/avatars/'.$item->avatar) }}" alt="Ana Crown" class="w-100" />
                                                    </div>
                                            </div>
                                            <!--end::Avatar-->
                                            <div class="ms-5">
